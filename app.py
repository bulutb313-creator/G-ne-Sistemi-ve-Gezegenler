...
def main():
    ...
    # API Anahtarını al ve kontrol et (Yanlış API Etiketini düzelten kritik kod)
    if "GEMINI_API_KEY" not in os.environ:
        st.error("Lütfen Gemini API Anahtarınızı giriniz. Anahtar olmadan sistem çalışmaz.")
        key = st.text_input("Gemini API Anahtarı:", type="password") # Etiket bu sefer kesinlikle doğru!
        if key:
