...
def get_rag_chain():
    ...
    try:
        ...
        # PROMPT ŞABLONU (Uzman rolü korunuyor)
        prompt_template = """Sen bir GÜNEŞ SİSTEMİ VE JEOFIZIK UZMANISIN. Görevin, sana verilen BAĞLAM'daki TÜM bilgileri kullanarak bir cevap SENTEZLEMEKTİR..."""
...
def main():
    ...
    if "GEMINI_API_KEY" not in os.environ:
        ...
        key = st.text_input("Gemini API Anahtarı:", type="password") # Etiket bu sefer kesinlikle doğru: Gemini
        if key:
