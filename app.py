...
def get_rag_chain():
    ...
    # 3. LLM, Retriever ve PROMPT (KAPSAMLI DÜŞÜNME AYARLARI)
    ...
    # *** YENİ PROMPT ŞABLONU: Düşünmeye, Sentezlemeye ve Detaylandırmaya Zorlama ***
...
def main():
    ...
    st.caption("Cevaplar sadece öğretilen veriden alınmıştır. 🛰️")
